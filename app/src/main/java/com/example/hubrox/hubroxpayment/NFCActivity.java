            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case MSG_BLOCK_NO_NONE:
                        Toast.makeText(NFCActivity.this, R.string.picc_block_no_none,
                                Toast.LENGTH_SHORT).show();

                        SoundTool.getMySound(NFCActivity.this).playMusic("error");
                        break;
                    case MSG_BLOCK_NO_ILLEGAL:
                        Toast.makeText(NFCActivity.this, R.string.picc_block_no_illegal,
                                Toast.LENGTH_SHORT).show();
                        SoundTool.getMySound(NFCActivity.this).playMusic("error");
                        break;
                    case MSG_AUTHEN_FAIL:
                        Toast.makeText(NFCActivity.this, R.string.picc_authen_fail,
                                Toast.LENGTH_SHORT).show();
                        SoundTool.getMySound(NFCActivity.this).playMusic("error");
                        break;
                    case MSG_AUTHEN_BEFORE:
                        Toast.makeText(NFCActivity.this, R.string.picc_authen_before,
                                Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case MSG_READ_FAIL:
                    case MSG_APDU_FAIL:
                        Toast.makeText(NFCActivity.this, R.string.picc_operate_fail,
                                Toast.LENGTH_SHORT).show();
                        break;
                    case MSG_BLOCK_DATA_NONE:
                        Toast.makeText(NFCActivity.this, R.string.picc_block_data_none,
                                Toast.LENGTH_SHORT).show();
                        break;
                    case MSG_SHOW_BLOCK_DATA:
                        SoundTool.getMySound(NFCActivity.this).playMusic("success");
                        String data = (String) msg.obj;
                        tvApdu.append("\n" + data);
                        break;
                    case MSG_ACTIVE_FAIL:
                        Toast.makeText(NFCActivity.this, R.string.picc_active_fail,
                                Toast.LENGTH_SHORT).show();
                        SoundTool.getMySound(NFCActivity.this).playMusic("error");
                        break;
                    case MSG_SHOW_APDU:
